                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                        <div class="service-item three">
                            <div class="service-icon">
                                <img src="{{asset('home/images/'.$service->image)}}" alt="icon">
                            </div>
                            <div class="service-content">
                                <h3 class="title"><a href="{{route('home.service.detail',['slug'=>$service->slug])}}">{{$service->title}}</a></h3>

                                <div class="service-btn">
                                    <a href="{{route('home.service.detail',['slug'=>$service->slug])}}" class="custom-btn">Learn More <i class="icon-Group-2361 ml-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
